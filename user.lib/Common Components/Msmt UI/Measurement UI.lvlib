...
<Library LVVersion="17008000">
	...
	<Item Name="Messages" Type="Folder">
		<Item Name="Ask Controller to Launch Results UI Msg.lvclass" Type="LVClass" URL="../Messages/Ask Controller to Launch Results UI Msg/Ask Controller to Launch Results UI Msg.lvclass"/>
		...
		<Item Name="Launch Step Configuration Msg.lvclass" Type="LVClass" URL="../../Measurement UI Messages/Launch Step Configuration Msg/Launch Step Configuration Msg.lvclass"/>
		...
		<Item Name="Send Run Measurement Message.lvclass" Type="LVClass" URL="../Messages/Send Run Measurement Message/Send Run Measurement Message.lvclass"/>
