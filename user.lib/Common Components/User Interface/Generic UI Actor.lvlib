...
<Library LVVersion="15008000">
	...
	<Item Name="Messages" Type="Folder">
		<Item Name="Disable UI Msg.lvclass" Type="LVClass" URL="../Messages/Disable UI Msg/Disable UI Msg.lvclass"/>
		<Item Name="Enable UI Msg.lvclass" Type="LVClass" URL="../Messages/Enable UI Msg/Enable UI Msg.lvclass"/>
		<Item Name="Initialize UI Message.lvclass" Type="LVClass" URL="../Messages/Initialize UI Message/Initialize UI Message.lvclass"/>
		<Item Name="Reset Controls Msg.lvclass" Type="LVClass" URL="../Messages/Reset Controls Msg/Reset Controls Msg.lvclass"/>
		<Item Name="Update Status Display.lvclass" Type="LVClass" URL="../Messages/Update Status Display/Update Status Display.lvclass"/>
	</Item>
